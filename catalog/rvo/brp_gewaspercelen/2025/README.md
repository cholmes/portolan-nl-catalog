...
| File | Description |
|---|---|
| `brp_gewaspercelen_2025.parquet` | GeoParquet, zstd, bbox-covering, spatially sorted |
| `brp_gewaspercelen_2025.pmtiles` | Vector tiles for web maps |
| `brp_gewaspercelen_2025.json` | STAC Item |
| `brpgewaspercelen_definitief_2025.gpkg` | Original PDOK source download |
