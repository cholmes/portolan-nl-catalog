# BRP Gewaspercelen 2010 — Agent/LLM Usage Guide

The 2010 edition of the Dutch Basisregistratie Gewaspercelen (BRP). One year of
agricultural parcel polygons with registered crop type. 782,837 polygons,
all snapshotted on 2010-05-15 (the CAP registration deadline). Definitief — finalized
after verification.

## When to use this year's file vs the parent glob

- **This year only:** point your tool at
  `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2010/brp_gewaspercelen_2010.parquet`
...
| jaar | int32 | `2010` everywhere in this file |
...
FROM read_parquet('https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2010/brp_gewaspercelen_2010.parquet')
...
- **PMTiles** (for web maps): `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2010/brp_gewaspercelen_2010.pmtiles`
...
- Each style file references `../brp_gewaspercelen_2010.pmtiles` so the year folder is self-contained.

## Source

- Source Esri File Geodatabase, zipped (PDOK definitive 2010): https://service.pdok.nl/rvo/gewaspercelen/atom/downloads/brpgewaspercelen_definitief_2010.zip
- License: CC0-1.0
