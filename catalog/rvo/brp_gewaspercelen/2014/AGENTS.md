# BRP Gewaspercelen 2014 — Agent/LLM Usage Guide

The 2014 edition of the Dutch Basisregistratie Gewaspercelen (BRP). One year of
agricultural parcel polygons with registered crop type. 765,006 polygons,
all snapshotted on 2014-05-15 (the CAP registration deadline). Definitief — finalized
after verification.

## When to use this year's file vs the parent glob

- **This year only:** point your tool at
  `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2014/brp_gewaspercelen_2014.parquet`
...
FROM read_parquet('https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2014/brp_gewaspercelen_2014.parquet')
...
- **PMTiles** (for web maps): `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2014/brp_gewaspercelen_2014.pmtiles`
- **MapLibre styles** in `./styles/`:
  ...
  - `landscape-elements.json` — highlights ditches, hedgerows, etc (empty for this year)
- Each style file references `../brp_gewaspercelen_2014.pmtiles` so the year folder is self-contained.

## Source

- Source Esri File Geodatabase, zipped (PDOK definitive 2014): https://service.pdok.nl/rvo/gewaspercelen/atom/downloads/brpgewaspercelen_definitief_2014.zip
- License: CC0-1.0
