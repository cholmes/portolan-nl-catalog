# BRP Gewaspercelen 2011 — Agent/LLM Usage Guide

The 2011 edition of the Dutch Basisregistratie Gewaspercelen (BRP). One year of
agricultural parcel polygons with registered crop type. 779,674 polygons,
all snapshotted on 2011-05-15 (the CAP registration deadline). Definitief — finalized
after verification.

## When to use this year's file vs the parent glob

- **This year only:** point your tool at
  `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2011/brp_gewaspercelen_2011.parquet`
...
| jaar | int32 | `2011` everywhere in this file |
...
FROM read_parquet('https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2011/brp_gewaspercelen_2011.parquet')
...
- **PMTiles** (for web maps): `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2011/brp_gewaspercelen_2011.pmtiles`
...
- Each style file references `../brp_gewaspercelen_2011.pmtiles` so the year folder is self-contained.

## Source

- Source Esri File Geodatabase, zipped (PDOK definitive 2011): https://service.pdok.nl/rvo/gewaspercelen/atom/downloads/brpgewaspercelen_definitief_2011.zip
- License: CC0-1.0
