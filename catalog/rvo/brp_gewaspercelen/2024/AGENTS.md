# BRP Gewaspercelen 2024 — Agent/LLM Usage Guide

The 2024 edition of the Dutch Basisregistratie Gewaspercelen (BRP). One year of
agricultural parcel polygons with registered crop type. 2,493,631 polygons,
all snapshotted on 2024-05-15 (the CAP registration deadline). Definitief — finalized
after verification.

## When to use this year's file vs the parent glob

- **This year only:** point your tool at
  `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2024/brp_gewaspercelen_2024.parquet`
...
| jaar | int32 | `2024` everywhere in this file |
...
FROM read_parquet('https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2024/brp_gewaspercelen_2024.parquet')
...
- **PMTiles** (for web maps): `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2024/brp_gewaspercelen_2024.pmtiles`
...
- Each style file references `../brp_gewaspercelen_2024.pmtiles` so the year folder is self-contained.

## Source

- Source GeoPackage (PDOK definitive 2024): https://service.pdok.nl/rvo/gewaspercelen/atom/downloads/brpgewaspercelen_definitief_2024.gpkg
- License: CC0-1.0
