# BRP Gewaspercelen 2009 — Agent/LLM Usage Guide

The 2009 edition of the Dutch Basisregistratie Gewaspercelen (BRP). One year of
agricultural parcel polygons with registered crop type. 819,146 polygons,
all snapshotted on 2009-05-15 (the CAP registration deadline). Definitief — finalized
after verification.

## When to use this year's file vs the parent glob

- **This year only:** point your tool at
  `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2009/brp_gewaspercelen_2009.parquet`
...
| jaar | int32 | `2009` everywhere in this file |
...
FROM read_parquet('https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2009/brp_gewaspercelen_2009.parquet')
...
- **PMTiles** (for web maps): `https://data.source.coop/cholmes/portolan-nl/rvo/brp_gewaspercelen/2009/brp_gewaspercelen_2009.pmtiles`
...
- Each style file references `../brp_gewaspercelen_2009.pmtiles` so the year folder is self-contained.

## Source

- Source Esri File Geodatabase, zipped (PDOK definitive 2009): https://service.pdok.nl/rvo/gewaspercelen/atom/downloads/brpgewaspercelen_definitief_2009.zip
- License: CC0-1.0
