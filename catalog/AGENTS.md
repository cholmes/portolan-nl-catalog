...
instant map visualization from object storage, and STAC+AGENTS.md for AI/agent access.
...
- Many collections have their own AGENTS.md with detailed field descriptions and queries
...
or [Gemini CLI](https://github.com/google-gemini/gemini-cli) at any collection's `AGENTS.md` and
ask it to query the data, build interactive maps, or generate charts. Every collection includes
an `AGENTS.md` with field descriptions, query examples, and usage context.
